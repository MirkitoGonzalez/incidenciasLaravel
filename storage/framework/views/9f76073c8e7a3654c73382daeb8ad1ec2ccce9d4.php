    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('incidencias_create')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\gestionlaravel\resources\views/incidencias/create.blade.php ENDPATH**/ ?>